...
if( !function_exists('ecommerce_star_settings') ){
		...
		function ecommerce_star_settings(){
			...
			'header_myaccount_text' => esc_html__('My Account', 'smart-shopper'),
			...
			'header_top_color' => '#4d4d4d',
			
			'slider_max_items' => 3,
			'slider_cat' => '',
			'slider_animation_type' => 'slide',
			'slider_speed' => 3000,
			'slider_button_text' => esc_html__('More Details', 'smart-shopper'),
			'slider_button_link' => '',
