...
function moving_company_lite_admin_theme_style() {
   ...
   wp_enqueue_style('moving-company-lite-custom-admin-style', get_template_directory_uri() . '/inc/getstart/getstart.css');
   wp_enqueue_script('moving-company-lite-tabs', get_template_directory_uri() . '/inc/getstart/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="moving_company_lite_open_tab(event, 'theme_lite')"><?php esc_html_e( 'Getting Started', 'moving-company-lite' ); ?></button>		  
				...
				<div class="info-link">
		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=moving_company_lite_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','moving-company-lite'); ?></a>
							</div>
							 <div class="row-box2">
