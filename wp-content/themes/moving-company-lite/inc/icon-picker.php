...
class Moving_Company_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'moving-company-lite' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $moving_company_lite_font_awesome_icon_array = moving_company_lite_font_awesome_icon_array();
                    foreach ($moving_company_lite_font_awesome_icon_array as $moving_company_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $moving_company_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($moving_company_lite_font_awesome_icon).'"></i>
                            <span class="moving-company-lite-social-class">'.esc_attr($moving_company_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function moving_company_lite_customizer_script() {     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'moving-company-lite-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'moving_company_lite_customizer_script' );

if(!function_exists('moving_company_lite_font_awesome_icon_array')){
    function moving_company_lite_font_awesome_icon_array(){
