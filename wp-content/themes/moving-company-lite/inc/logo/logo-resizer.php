...
function moving_company_lite_customize_preview_js() {
	wp_enqueue_script( 'moving-company-lite-customizer', get_template_directory_uri() . '/inc/logo/js/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function moving_company_lite_customize_controls_js() {
	wp_enqueue_script( 'moving-company-lite-customizer-controls', get_template_directory_uri() . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
