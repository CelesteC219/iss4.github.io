...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'moving_company_lite_slider_arrows') != '') { ?>
    ...
    <div class="container-fluid p-0">
      <div class="row m-0">
        ...
        <div class="p-0 <?php if(get_theme_mod('moving_company_lite_social_media')) { ?>col-lg-11 col-md-11" <?php } else { ?>col-lg-12 col-md-12" <?php } ?>">
          <div id="slider">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'moving_company_lite_slider_speed',3000)) ?>"> 
                    ...
                    <div class="carousel-caption">
                      <div class="inner_carousel">
                        ...
                        <?php if( get_theme_mod('moving_company_lite_slider_button_text','READ MORE') != ''){ ?>
                          <div class="more-btn">
                            <a href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html(get_theme_mod('moving_company_lite_slider_button_text',__('READ MORE','moving-company-lite')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('moving_company_lite_slider_button_text',__('READ MORE','moving-company-lite')));?></span></a>
                          </div>
                        <?php } ?>
                      </div>
                    </div>
