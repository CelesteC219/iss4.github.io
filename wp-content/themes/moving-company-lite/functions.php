...
function moving_company_lite_sanitize_email( $email, $setting ) {
...
//Define
define('MOVING_COMPANY_LITE_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-moving-company-lite/','moving-company-lite'));
...
define('MOVING_COMPANY_LITE_BUY_NOW',__('https://www.vwthemes.com/themes/moving-company-wordpress-theme/','moving-company-lite'));
define('MOVING_COMPANY_LITE_LIVE_DEMO',__('https://www.vwthemes.net/vw-moving-company-pro/','moving-company-lite'));
define('MOVING_COMPANY_LITE_PRO_DOC',__('https://www.vwthemesdemo.com/docs/vw-moving-company-pro/','moving-company-lite'));
...
define('MOVING_COMPANY_LITE_CREDIT',__('https://www.vwthemes.com/themes/free-moving-company-wordpress-theme/','moving-company-lite'));
