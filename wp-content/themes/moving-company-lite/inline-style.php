<?php
	...
	if($moving_company_lite_first_color != false){
		$moving_company_lite_custom_css .='.wp-block-button, .wp-block-button__link{';
			$moving_company_lite_custom_css .='background-color: '.esc_html($moving_company_lite_first_color).'!important;';
		$moving_company_lite_custom_css .='}';
	}
	if($moving_company_lite_first_color != false){
	...
	if($moving_company_lite_second_color != false){
		$moving_company_lite_custom_css .='.wp-block-button:hover, .wp-block-button .wp-block-button__link:hover{';
			$moving_company_lite_custom_css .='background-color: '.esc_html($moving_company_lite_second_color).'!important;';
		$moving_company_lite_custom_css .='}';
	}
	if($moving_company_lite_second_color != false){
	...
	if($moving_company_lite_slider_height != false){
		$moving_company_lite_custom_css .='#slider img{';
			$moving_company_lite_custom_css .='height: '.esc_html($moving_company_lite_slider_height).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_sticky_header_padding != false){
		$moving_company_lite_custom_css .='.header-fixed{';
			$moving_company_lite_custom_css .='padding: '.esc_html($moving_company_lite_sticky_header_padding).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_scroll_to_top_font_size != false){
		$moving_company_lite_custom_css .='.scrollup i{';
			$moving_company_lite_custom_css .='font-size: '.esc_html($moving_company_lite_scroll_to_top_font_size).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_scroll_to_top_padding != false){
		$moving_company_lite_custom_css .='.scrollup i{';
			$moving_company_lite_custom_css .='padding-top: '.esc_html($moving_company_lite_scroll_to_top_padding).';padding-bottom: '.esc_html($moving_company_lite_scroll_to_top_padding).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_scroll_to_top_width != false){
		$moving_company_lite_custom_css .='.scrollup i{';
			$moving_company_lite_custom_css .='width: '.esc_html($moving_company_lite_scroll_to_top_width).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_scroll_to_top_height != false){
		$moving_company_lite_custom_css .='.scrollup i{';
			$moving_company_lite_custom_css .='height: '.esc_html($moving_company_lite_scroll_to_top_height).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_scroll_to_top_border_radius != false){
		$moving_company_lite_custom_css .='.scrollup i{';
			$moving_company_lite_custom_css .='border-radius: '.esc_html($moving_company_lite_scroll_to_top_border_radius).'px;';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_social_icon_font_size != false){
		$moving_company_lite_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$moving_company_lite_custom_css .='font-size: '.esc_html($moving_company_lite_social_icon_font_size).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_social_icon_padding != false){
		$moving_company_lite_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$moving_company_lite_custom_css .='padding: '.esc_html($moving_company_lite_social_icon_padding).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_social_icon_width != false){
		$moving_company_lite_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$moving_company_lite_custom_css .='width: '.esc_html($moving_company_lite_social_icon_width).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_social_icon_height != false){
		$moving_company_lite_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$moving_company_lite_custom_css .='height: '.esc_html($moving_company_lite_social_icon_height).';';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_social_icon_border_radius != false){
		$moving_company_lite_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$moving_company_lite_custom_css .='border-radius: '.esc_html($moving_company_lite_social_icon_border_radius).'px;';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_products_padding_top_bottom != false){
		$moving_company_lite_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$moving_company_lite_custom_css .='padding-top: '.esc_html($moving_company_lite_products_padding_top_bottom).'!important; padding-bottom: '.esc_html($moving_company_lite_products_padding_top_bottom).'!important;';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_products_padding_left_right != false){
		$moving_company_lite_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$moving_company_lite_custom_css .='padding-left: '.esc_html($moving_company_lite_products_padding_left_right).'!important; padding-right: '.esc_html($moving_company_lite_products_padding_left_right).'!important;';
		$moving_company_lite_custom_css .='}';
	}
	...
	if($moving_company_lite_products_box_shadow != false){
		$moving_company_lite_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$moving_company_lite_custom_css .='box-shadow: '.esc_html($moving_company_lite_products_box_shadow).'px '.esc_html($moving_company_lite_products_box_shadow).'px '.esc_html($moving_company_lite_products_box_shadow).'px #ddd;';
		$moving_company_lite_custom_css .='}';
	}

	$moving_company_lite_products_border_radius = get_theme_mod('moving_company_lite_products_border_radius');
	if($moving_company_lite_products_border_radius != false){
		$moving_company_lite_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$moving_company_lite_custom_css .='border-radius: '.esc_html($moving_company_lite_products_border_radius).'px;';
		$moving_company_lite_custom_css .='}';
	}