...
add_action('wp_ajax_estimate_product_Export', 'wc_estimate_product_Export');
add_action('wp_ajax_nopriv_estimate_product_Export', 'wc_estimate_product_Export');

function wc_estimate_product_Export(){
...
function estimate_product_Export_as_Pdf()
{
    ...
    <div class="estimate" style="font-size: 14px;page-break-inside: auto">
        ...
        <div style="width:60%; float:left">
            <table style="width:100%">
                <tr>
                    <th colspan="2" style="font-size:10px;font-family: Arial, Helvetica, sans-serif;">USER DETAILS</th>
                </tr>
                <tr>
                    <th style="font-size:10px;font-family: Arial, Helvetica, sans-serif;">End User</th>
                    <td style="font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo $estimateData['user_name']; ?></td>
                </tr>
                <tr>
                    <th style="font-size:10px;font-family: Arial, Helvetica, sans-serif;">Contact Person</th>
                    <td style="font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo $estimateData['user_contact_person']; ?></td>
                </tr>
                <tr>
                    <th style="font-size:10px;font-family: Arial, Helvetica, sans-serif;">Contact Number</th>
                    <td style="font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo $estimateData['user_contact']; ?></td>
                </tr>
                <tr>
                    <th style="font-size:10px;font-family: Arial, Helvetica, sans-serif;">Email</th>
                    <td style="font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo $estimateData['user_email']; ?></td>
                </tr>
                <tr>
                    <th style="font-size:10px;font-family: Arial, Helvetica, sans-serif;">Address</th>
                    <td style="font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo $estimateData['user_address']; ?></td>
                </tr>
            </table>
        </div>
        <div style="width:100%;clear:both;">
            <table style="width:35%">
                <tr>
                    <th colspan="2" style="font-size:10px;font-family: Arial, Helvetica, sans-serif;">ESTIMATE DETAILS
                    </th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 0px;font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo ese_attr('00' . $estimateId); ?></td>
                </tr>
                <tr>
                    <th style="padding: 0px;font-size:10px;font-family: Arial, Helvetica, sans-serif;">Estimate Name:
                    </th>
                    <td style="padding: 0px;font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo ese_attr($estimateData['estimate_name']); ?></td>
                </tr>
                <tr>
                    <th style="padding: 0px;font-size:10px;font-family: Arial, Helvetica, sans-serif;">Estimate
                        Description
                    </th>
                    <td style="padding: 0px;font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php echo ese_attr($estimateData['estimate_description']); ?></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="padding: 0px;font-size:10px;font-family: Arial, Helvetica, sans-serif;"><?php $days = get_option('delete_time');
                        $timestamp = strtotime($estimateData['cdate'] . $days . 'day');
        ...
        <div class="products" style="width:100%;margin-top: 10px">
            <table style="width:100%;border-collapse: collapse; border:1px solid gray;">
                <tr>
                    <th style="padding: 5px;font-size:10px;font-family: Arial, Helvetica, sans-serif;width:20%">Product
                        Numer
                    </th>
                    <th style="padding: 5px;font-size:10px;font-family: Arial, Helvetica, sans-serif;width:45%">
                        Description
                    </th>
                    <th style="padding: 5px;font-size:10px;font-family: Arial, Helvetica, sans-serif;text-align: right;width:10%">
                        Unit Price
                    </th>
                    <th style="padding: 5px;font-size:10px;font-family: Arial, Helvetica, sans-serif;;width:10%;text-align: center">
                        Qty
                    </th>
                    <th style="padding: 5px;font-size:10px;font-family: Arial, Helvetica, sans-serif;text-align: right;">
                        Total Price
                    </th>
                </tr>
                <?php
                ...
                <tr>
                    <td style="text-align: right;padding: 5px;font-size:10px;font-family: Arial, Helvetica, sans-serif;"
                        colspan="4">Subtotal
                    </td>
        ...
        <div class="note" style="text-align: center;width:100%;clear:both;margin-top: 10px">
            <p style="color:red;margin: 5px">Price Estimate for planning and information purposes only and is not a
