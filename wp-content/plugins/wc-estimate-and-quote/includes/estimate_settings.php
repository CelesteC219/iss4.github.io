...
class wc_Estimate_Settings {
	...
	public static function register_settings_optings() {
		...
		register_setting( 'get_estimate_settings_group', 'innovs_wc_es_menu' );
		register_setting( 'get_estimate_settings_group', 'per_page' );
 	    ...
 	    register_setting( 'get_estimate_settings_group', 'innovs_wc_es_limit' );
 	    register_setting( 'get_estimate_settings_group', 'innovs_wc_es_export_footer' );
 	    register_setting( 'get_estimate_settings_group', 'company_name' );
 	    register_setting( 'get_estimate_settings_group', 'innovs_wc_es_category1' );
 	    register_setting( 'get_estimate_settings_group', 'innovs_wc_es_category2' );
 	    register_setting( 'get_estimate_settings_group', 'set_currency' );
		return true;
	}
}

new wc_Estimate_Settings();
