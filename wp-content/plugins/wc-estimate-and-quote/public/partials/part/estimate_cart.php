    ...
    <div class="card innovs-pe-card">
        <div class="card-header innovs-pe-card-header">
            ...
            <ul class="list-inline listMenu innovs-pe-decec-menu">
                ...
                <li class="list-inline-item"><a id="btn_email" data-id="<?php echo isset($_GET['estimate-id']) ? $_GET['estimate-id'] : ''; ?>" class="social-icon text-xs-center" target="_blank" href="#"><i class="far fa-envelope"></i> Email</a></li>
        ...
        <div class="card-body innovs-pe-card-body">
            ...
            <div class="shopping-cart innovs-pe-shoppin-cart">
                ...
                <div class="column-labels innovs-pe-colums-labels">
                    ...
                    <label class="product-code">Product Name</label>
                    <label class="product-details text-left">Description</label>
